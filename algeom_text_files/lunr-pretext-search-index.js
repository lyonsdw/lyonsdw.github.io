...
},
{
  ...
  "body": " Combined Course on Groups and Geometries    Ch. 1 Preliminaries  1.1 1.4  3 weeks   Ch. 2 Groups  2.1 2.5  6 weeks   Ch. 3 Geometries  3.1 3.5  6 weeks    "
},
{
  ...
  "body": " Stand-alone Course on Group Theory    Ch. 1 Preliminaries  1.1,1.4  1.5 weeks   Ch. 2 Groups  2.1 2.6  12 weeks   Final Project   1.5 weeks    "
},
{
  ...
  "body": " Stand-alone Course on Modern Geometries    Ch. 1 Preliminaries  1.2,1.3  1.5 weeks   Ch. 3 Geometries  3.1 3.6  12 weeks   Final Project   1.5 weeks    "
},
{
  "id": "frontmatter-5",
  "level": "1",
  ...
  "body": "About the author  David W. Lyons is a professor of mathematics at Lebanon Valley College in Annville, Pennsylvania, USA, where he has led a student-faculty research program in quantum information science since 2002.   For more information, visit Lyons' academic website .  "
},
{
...
},
{
  ...
  "body": "Circles and lines   For a real variable and a real constant , completing the square refers to rewriting the expression as . A complex version of completing the square for a complex variable and a complex constant is the following. Write a derivation to justify this. Then use completing the square to find the center and radius of the circle given by the equation .  Write an alternative proof for the general form for the equation of a line , as follows. Let , , . Find the equation of the line in terms of the real variables and real constants . Explain why it is necessary that .     "
},
{
...
},
{
  ...
  "number": "1.4.3",
  "title": "",
  "body": "  A key component of is that equivalence classes are disjoint. Let be an equivalence relation on a set , and let . Show that either or .   "
},
{
  "id": "welldefinedness",
  "level": "2",
...
},
{
  ...
  "body": "Subgroups of and    Let be a subgroup of . Show that either or , where is the smallest positive element in .  Let be a subgroup of . Show that either or , where is the smallest positive element in .  Let be positive integers. Show that      Suggestion for part (c): Do the case first.    Consequence of this exercise: The greatest common divisor of integers is the smallest positive integer of the form over all integers . Two integers are relatively prime if and only if there exist integers such that .   "
},
{
  "id": "center",
  "level": "2",
...
},
{
  ...
  "body": " Basic properties of homomorphisms   Let be a homomorphism of groups. Let denote the identity elements of , respectively. We have the following.   for all  is a subgroup of  is a subgroup of  if and only if  if and only if  is one-to-one if and only if     "
},
{
  "id": "gmodkisgroup",
  "level": "2",
...
},
{
  ...
  "body": "The sign of a permutation  Let be a positive integer, and let be the polynomial in the variables . For example, we have . Given a permutation in , let be the polynomial In the exercises below, you will show that for all in . This allows us to define the sign permutation  sign of a permutation  of a permutation , denoted  the sign of a permutation   , to be or according to whether or , respectively. We say that a permutation is even permutation even permutation  if , and we say is odd permutation odd permutation  if .  Write expressions for , , and (write all the factors). All three expressions consist of the same factors, possibly times . Identify which factors of and have the opposite sign of the corresponding factor in Use your expressions to find and .  Generalize the examples in part (a) above to show that for all in . This justifies the definition of the sign of a permutation.  Show that for any transposition in . Suggestion: Let be a transposition with . Count the number of factors of such that .  Define by for in . Show that for all in .  Let be an element of . By , may be written as a product of transpositions . Use to show that . Consequence: if is expressible as a product of an even number of transpositions, then is an even permutation. Further, any product of transpositions that equals must have an even number of transpositions. (A similar statement holds replacing the word even by the word odd .)  Show that defines a group action of the group on the set .  Show that the sign function is a homomorphism of groups.  The subset of even permutations of is denoted . Give two arguments why is a normal subgroup of . Use (i) the 1-step or the 2-step subgroup test and definition , and (ii) using criterion 1 of . This group is called the alternating group alternating group groups, list of alternating group  the alternating group .     For part (d): Both sides of are equal to .   "
},
{
  "id": "gpselfactionexer",
  "level": "2",
...
},
{
  ...
  "number": "2.5.6",
  "title": "",
  "body": "  Prove The Orbit-Stabilizer Theorem ( ).   Let , and define a map given by . Apply to get a one-to-one correspondence Then use to show that . Whatever proof method you use, you must address the issue of well-definedness of one of the maps or .   "
},
{
...
},
{
  ...
  "number": "3.2.1",
  "title": "",
  "body": "  Show that if , then defines a one-to-one and onto map by finding an explicit inverse for and showing that and are both the identity function on .  Show that if , then defines a one-to-one and onto map by finding an explicit inverse for and showing that is the identity function on and is the identity function on .  For both cases 1 and 2 above, identify precisely where you use the condition . Show that, in fact, is invertible if and only if .     "
},
{
...
{
  "id": "mobiusgeomsect-4-7",
  "level": "2",
  "url": "mobiusgeomsect.html#mobiusgeomsect-4-7",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "fixed points "
...
},
{
  ...
  "number": "3.2.22",
  "title": "",
  "body": " Explain how follows from .   Start here: Let be two clines. Let be three points on and let be three points on . Let , let , and let . Explain why takes to .   "
},
{
...
},
{
  ...
  "body": "Decomposition of Möbius transformations into four basic types     Let be a nonzero complex constant. Explain why the transformation is a composition of a homothety and a rotation.  Explicitly identify each homothety, rotation, translation, and inversion in to in the derivation below for the case .   Write your own decomposition for the case .     "
},
{
  "id": "ftomgexer",
  "level": "2",
  ...
  "number": "3.2.8.2",
  "title": "",
  "body": " Prove the Fundamental Theorem of Möbius Geometry ( ).    Start by applying to the triples and .   "
},
{
...
},
{
  ...
  "number": "3.2.8.8",
  "title": "",
  "body": " Let be the single fixed point of a Möbius transformation that is conjugate to via . Show that the single line in the degenerate Steiner clines through is parallel to the direction given by .   Show that , so takes to . Thus the single degenerate Steiner straight line through is in the direction given by the argument of , that is, in the direction .   "
},
{
...
},
{
  ...
  "number": "3.3.5",
  "title": "",
  "body": "A Möbius transformation is in if and only if can be written in the form for some and . Alternatively, we have if and only if can be written in the form for some such that .   "
},
{
...
},
{
  ...
  "number": "3.3.8",
  "title": "",
  "body": " Show that a hyperbolic straight line that contains 0 must be a diameter of the unit circle.   Prove the contrapositive: assume is a hyperbolic straight line that is also a Euclidean circle, and intersects the unit circle orthogonally at . Give an argument why  cannot contain 0.   "
},
{
...
},
{
  ...
  "number": "3.5.3",
  "title": "",
  "body": " Man drawing a lute , Albrecht Dürer, 1525 (Wikipedia Commons).   "
},
{
  "id": "projgeomsect-6-6",
  "level": "2",
...
},
{
  ...
  "number": "3.5.5.6",
  "title": "",
  "body": "The following is a famous theorem of classical geometry.  Pappus' Theorem . Pappus' Theorem  Let be three distinct collinear points in . Let be another three distinct collinear points on a different line. Let be the intersection points , , . Then points are collinear. See .   Follow the outline below to prove Pappus' Theorem under the additional assumption that no three of are collinear. Applying the Fundamental Theorem of Projective Geometry, we may assume , , , and .  Check that and .  Explain why it follows that and for some .  Explain why and .  Explain why .  Observe that all lie on .     For the second bullet point, use the fact that lies on to get . For the third bullet point, use known coordinates for to get coordinates for lines . Then . Use a similar process for . For the fourth bullet point, use .   "
},
{
  "id": "quadricsexer",
  "level": "2",
