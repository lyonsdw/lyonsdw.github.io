...
{
  "id": "sets_counting_section-3-6",
  "level": "2",
  "url": "sets_counting_section.html#sets_counting_section-3-6",
  "type": "Checkpoint",
  "number": "1.3",
  "title": "",
...
{
  "id": "sets_counting_section-4-4",
  "level": "2",
  "url": "sets_counting_section.html#sets_counting_section-4-4",
  "type": "Checkpoint",
  "number": "1.5",
  "title": "",
...
{
  "id": "sets_counting_section-4-7",
  "level": "2",
  "url": "sets_counting_section.html#sets_counting_section-4-7",
  "type": "Checkpoint",
  "number": "1.7",
  "title": "",
...
{
  "id": "sets_counting_section-5-3",
  "level": "2",
  "url": "sets_counting_section.html#sets_counting_section-5-3",
  "type": "Checkpoint",
  "number": "1.9",
  "title": "",
...
{
  "id": "sets_counting_section-5-7",
  "level": "2",
  "url": "sets_counting_section.html#sets_counting_section-5-7",
  "type": "Checkpoint",
  "number": "1.11",
  "title": "",
...
{
  "id": "sets_counting_section-6-3",
  "level": "2",
  "url": "sets_counting_section.html#sets_counting_section-6-3",
  "type": "Checkpoint",
  "number": "1.12",
  "title": "",
...
{
  "id": "sets_counting_section-7-3",
  "level": "2",
  "url": "sets_counting_section.html#sets_counting_section-7-3",
  "type": "Checkpoint",
  "number": "1.13",
  "title": "",
  "body": "  Give an example of a function that is one-to-one and onto, and that is not the identity function.  Give an example of a function that is one-to-one but not onto.  Give an example of a function that is onto but not one-to-one.  Give an example of a function that is neither one-to-one nor onto, and that is not a constant function.  Let be the set of all sequences in . Suppose that is one-to-one and onto. Define an element of by . Is it possible that is in the image of ? What do you conclude about ?    "
},
{
  "id": "sets_counting_section-8-2",
  "level": "2",
  "url": "sets_counting_section.html#sets_counting_section-8-2",
  "type": "Exercise",
  "number": "1.6.1",
  "title": "",
...
{
  "id": "probability_finite_section-3-7",
  "level": "2",
  "url": "probability_finite_section.html#probability_finite_section-3-7",
  "type": "Checkpoint",
  "number": "2.4",
  "title": "",
...
{
  "id": "probability_finite_section-3-9",
  "level": "2",
  "url": "probability_finite_section.html#probability_finite_section-3-9",
  "type": "Checkpoint",
  "number": "2.6",
  "title": "",
...
},
{
  ...
  "number": "2.9",
  "title": "",
  "body": " Show that is a probability function. Let be events in , and let be the events and . Show that are independent in if .  "
},
{
...
},
{
  ...
  "number": "2.10",
  "title": "",
  "body": " Show that is a probability function. Let be an event in , and let be the events , , Show that are dependent in if .  "
},
{
...
{
  "id": "probability_finite_section-6-5",
  "level": "2",
  "url": "probability_finite_section.html#probability_finite_section-6-5",
  "type": "Checkpoint",
  "number": "2.11",
  "title": "",
...
{
  "id": "probability_finite_section-7-4",
  "level": "2",
  "url": "probability_finite_section.html#probability_finite_section-7-4",
  "type": "Exercise",
  "number": "2.5.3",
  "title": "",
...
{
  "id": "probability_general_section-3-4",
  "level": "2",
  "url": "probability_general_section.html#probability_general_section-3-4",
  "type": "Checkpoint",
  "number": "3.2",
  "title": "",
  "body": "   Show that the definition of the probability space (see ) works for countably infinite descrete models .  Do simple random samples make sense for infinite probability spaces?    "
},
{
...
{
  "id": "probability_general_section-3-7",
  "level": "2",
  "url": "probability_general_section.html#probability_general_section-3-7",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
{
  "id": "probability_general_section-3-8",
  "level": "2",
  "url": "probability_general_section.html#probability_general_section-3-8",
  "type": "Checkpoint",
  "number": "3.4",
  "title": "",
  "body": "Show that the function is indeed a probability function.  "
},
{
...
},
{
  ...
  "number": "4.10",
  "title": "",
  "body": "   Make up several random variables on small finite probability spaces. Calculate their expected values.  Let be a random variable and let . Show that .  Justify .    "
},
{
...
},
{
  ...
  "number": "4.11",
  "title": "",
  "body": "   Calculate the variance for each of the examples you made up in the previous Checkpoint.  Let be a random variable and let . Show that .  Show the two expressions for variance are equal.    "
},
{
...
},
{
  ...
  "number": "4.17",
  "title": "",
  "body": "  Show by example that the converse of is false.  Show that two discrete random variables on a finite sample space are independent if and only if for every pair of sets . This demonstrates why we use the term independent .    "
},
{
...
{
  "id": "sampling1_section-2-4",
  "level": "2",
  "url": "sampling1_section.html#sampling1_section-2-4",
  "type": "Checkpoint",
  "number": "6.2",
  "title": "",
  "body": " Prove for the case of discrete variables.  Prove for the case of continuous variables that have density functions.  "
},
{
...
{
  "id": "sampling1_section-2-8",
  "level": "2",
  "url": "sampling1_section.html#sampling1_section-2-8",
  "type": "Checkpoint",
  "number": "6.4",
  "title": "",
  "body": " Prove for the case of discrete variables.  Prove for the case of continuous variables that have density functions.  "
...
{
  "id": "sampling1_section-4-3",
  "level": "2",
  "url": "sampling1_section.html#sampling1_section-4-3",
  "type": "Checkpoint",
  "number": "6.7",
  "title": "",
  "body": "   Find the probability function, the distribution function, and find the mean and the variance for the binomial distribution.  Find the probability function, the distribution function, and find the mean and the variance for the geometric distribution.  Find the probability density function and find the mean and the variance for the exponential distribution.    "
},
{
...
{
  "id": "sampling2_section-2-4",
  "level": "2",
  "url": "sampling2_section.html#sampling2_section-2-4",
  "type": "Checkpoint",
  "number": "7.2",
  "title": "",
...
{
  "id": "sampling2_section-3-3",
  "level": "2",
  "url": "sampling2_section.html#sampling2_section-3-3",
  "type": "Checkpoint",
  "number": "7.3",
  "title": "",
  "body": "   Show that .  Explain why holds.  Read Section 5.2 and do odd numbered exercises at the end of the section in .    "
},
{
...
{
  "id": "sampling2_section-4-4",
  "level": "2",
  "url": "sampling2_section.html#sampling2_section-4-4",
  "type": "Checkpoint",
  "number": "7.4",
  "title": "",
  "body": " Read Section 5.2 in .  "
},
{
...
},
{
  ...
  "number": "7.4.2",
  "title": "",
  "body": " Work the odd numbered exercises at the end of Section 5.2 in .  "
},
{
...
{
  "id": "regression_section-3-3",
  "level": "2",
  "url": "regression_section.html#regression_section-3-3",
  "type": "Checkpoint",
  "number": "8.1",
  "title": "",
...
{
  "id": "regression_section-4-4",
  "level": "2",
  "url": "regression_section.html#regression_section-4-4",
  "type": "Checkpoint",
  "number": "8.2",
  "title": "",
