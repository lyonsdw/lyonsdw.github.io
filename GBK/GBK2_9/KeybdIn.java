...
public class KeybdIn
{
    ...
    public static double readLineDouble()
    {
        ...
        while (! done)
        {
            ...
            {
	      String message = "Bad input data format.\n";
	      message += "Please enter a terminating decimal\n";
	      message += "representation of a number.";
	      System.out.println(message);
            }
        }
   ...
   /**********************************************************
    ...
    public static String readWord()
    {
        ...
        if (next == '\r')
        {
            ...
            {
                System.out.println(
                    "Fatal Error in method readWord of class KeybdIn.");
                System.exit(1);
            }
        }
